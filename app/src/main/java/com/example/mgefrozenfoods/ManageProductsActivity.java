...
public class ManageProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminProductList.add(new AdminProduct("PopCorn Chicken", "₱180.00", "PUREFOODS", 8, R.drawable.papi));
        adminProductList.add(new AdminProduct("Pork Tonkatsu", "₱350.00", "PUREFOODS", 2, R.drawable.idk));
        adminProductList.add(new AdminProduct("Squid Rings", "₱220.00", "PUREFOODS", 20, R.drawable.rings));
        ...
        adminProductList.add(new AdminProduct("Hotdog Bacon Wrap", "₱210.00", "PUREFOODS", 10, R.drawable.rap));
        adminProductList.add(new AdminProduct("Beef Tapa", "₱280.00", "PUREFOODS", 15, R.drawable.bip));
        adminProductList.add(new AdminProduct("Lechon Roll", "₱320.00", "PUREFOODS", 7, R.drawable.laman));
        adminProductList.add(new AdminProduct("Bangus", "₱190.00", "PUREFOODS", 25, R.drawable.daing));
        ...
        adminProductList.add(new AdminProduct("Nuggets", "₱420.00", "UNBRANDED", 11, R.drawable.nuggets));
        adminProductList.add(new AdminProduct("Black Pepper Chicken Nuggets", "₱270.00", "UNBRANDED", 1, R.drawable.black));
        ...
        adminProductList.add(new AdminProduct("Chicken Fingers", "₱190.00", "UNBRANDED", 9, R.drawable.fingers));
