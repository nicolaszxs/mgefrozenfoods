...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnPlaceOrder).setOnClickListener(v -> {
            ...
            String newOrderId = "Order #" + (orderList.size() + 1);
    ...
    private void loadAllProducts() {
        ...
        allProductsList.add(new Product("Bacon", "₱350.00", "FOOD CRAFTERS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Promeat Longgadog", "₱270.00", "PROMEAT", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Mozza Bomb", "₱240.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("PopCorn Chicken", "₱180.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Pork Tonkatsu", "₱350.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Squid Rings", "₱220.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Promeat Hungarian", "₱350.00", "PROMEAT", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Promeat Ham", "₱320.00", "PROMEAT", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Luncheon Meat", "₱280.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Hotdog Bacon Wrap", "₱210.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Beef Tapa", "₱280.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Lechon Roll", "₱320.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Bangus", "₱190.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("CDO FUNTASTYK PORK TOCINO", "₱190.00", "CDO", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Carneval Spicy Hungarian Sausage", "₱350.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Nuggets", "₱420.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Black Pepper Chicken Nuggets", "₱270.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Crispy Chicken Cop", "₱250.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Rib Steak", "₱540.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Garlic Longganisang Calumpit", "₱180.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Chicken Fingers", "₱190.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Tempura Ebi", "₱295.00", "UNBRANDED", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Purefoods TenderJuicy Hotdog", "₱270.00", "PUREFOODS", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Topmeat Pork Tocino", "₱290.00", "TOP MEAT", R.mipmap.ic_launcher));
        allProductsList.add(new Product("Beef Trimming", "₱290.00", "UNBRANDED", R.mipmap.ic_launcher));
    }
